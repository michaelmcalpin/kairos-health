...
export const EXTRACT_COLUMNS: Record<ProtocolType, ExtractColumn[]> = {
  ...
  diet: [
    { key: "day", label: "Day", type: "text", hint: "the day this meal is scheduled, e.g. Monday, Day 1, High Carb Day; blank if the plan is the same every day" },
    { key: "mealType", label: "Meal Type", type: "text", hint: "one of Breakfast, Lunch, Dinner, or Snack" },
    { key: "meal", label: "Meal", type: "text", hint: "meal name/label, e.g. Meal 1, Morning Smoothie" },
