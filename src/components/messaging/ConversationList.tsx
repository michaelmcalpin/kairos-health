      ...
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-[#D4AF37]/10 text-[#D4AF37] hover:bg-[#D4AF37]/20 flex items-center justify-center transition-colors"
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#D4AF37]/50"
          />
        </div>
          ...
          filtered.map((conv) => (
            <button
              ...
              className={`w-full p-4 text-left border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors ${
                selectedId === conv.id ? "bg-gray-800/50 border-l-2 border-l-[#D4AF37]" : ""
              }`}
            >
              <div className="flex items-start gap-3">
                ...
                {/* Unread badge */}
                {conv.unreadCount > 0 && (
                  <span className="w-5 h-5 rounded-full bg-[#D4AF37] text-[#122055] text-xs font-bold flex items-center justify-center flex-shrink-0">
