...
export default function GoalDetailScreen() {
  ...
  // Map to display format from real API data only. While the query is in
  // flight `goal` stays null and we render a spinner; if the id resolves to
  // nothing we render an honest not-found state — never sample data.
  const goal: GoalDetailDisplay | null = apiGoal ? mapApiGoalToDetail(apiGoal) : null;
